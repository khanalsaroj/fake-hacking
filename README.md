...
> No real networks, servers, or systems are touched.

---

## 🎬 What Is This?

**FAKE HACKING** is a high-fidelity **terminal hacking simulator** that recreates the *feel* of a full red-team
operation:
...
This project is built for Linux terminals.
Windows users should run via **WSL (Windows Subsystem for Linux)**.
